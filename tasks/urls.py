...
from tasks.views import TaskStatusUpdateView, TagUpdateView, TagDeleteView, TagCreateView, TagListView, TaskUpdateView, \
    TaskDeleteView, TaskCreateView, TaskListView
